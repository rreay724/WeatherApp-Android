...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "4024729c86bc2586447d58766e06a7a8";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mCurrentLocationButton = findViewById(R.id.locationButton);

        // TODO: add onClickListener for Current Location Button
